...
pub fn player_enum_to_string<'a>(player: &Color) -> &'a str {
    let mut _player: &str = "";
    match player {
        Color::White => {
            _player = "WHITE";
...
pub fn get_squares_under_attack_by_player(state: &State, player: Color) -> HashMap<usize, bool> {
    let mut squares_under_attack_map: HashMap<usize, bool> = HashMap::new();
...
pub fn piece_is_on_board(board: &Board, piece_id: isize) -> bool {
